package org.example.userserviceaugmorning.security;
...
public class SecurityConfig {
    ...
    // a way to create the user.
    // hardcoded user in DB
    // in DB we store hashed password.
    @Bean
    ...
    // register the client, Scaler, with this the Auth Server.
    // this data is stored in In-Memory
    // should we store this client data in DB? yes.
